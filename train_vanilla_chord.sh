...
# for model training
if [ $BPE -eq 0 ]; then
DATA_BIN=vanilla_${MAX_POS_LEN}_chord_hardloss${IGNORE_META_LOSS}
else
DATA_BIN=vanilla_${MAX_POS_LEN}_chord_bpe_hardloss${IGNORE_META_LOSS}
fi
